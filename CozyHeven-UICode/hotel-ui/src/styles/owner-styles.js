...
export const ownerStyles = {
    ...
    statValue: (color) => ({ fontSize: 22, fontWeight: 700, color, fontFamily: "'Playfair Display',serif" }),
    ...
    filterChip: {
        ...
        background: COLORS.warm, border: `1px solid ${COLORS.border}`,
        fontSize: 12, color: "#444", fontWeight: 500, cursor: "pointer",
    },
    filterChipActive: {
        padding: "5px 12px", borderRadius: 20,
        background: COLORS.gold, color: COLORS.white, border: `1px solid ${COLORS.gold}`,
    ...
    /* ── Hotel info card ── */
    infoRow:   { display: "flex", gap: 16, padding: "10px 0", borderBottom: `1px solid ${COLORS.border}`, fontSize: 13 },
    infoKey:   { color: COLORS.muted, minWidth: 110 },
